...
template<typename T_VAR, typename T_INDICES> class ScatterSubGrad {
public:
    __aicore__ inline ScatterSubGrad() {}
...
extern "C" __global__ __aicore__ void scatter_sub(GM_ADDR var, GM_ADDR indices, GM_ADDR updates, GM_ADDR workspace, GM_ADDR tiling) {
    ...
    ScatterSubGrad<DTYPE_VAR, DTYPE_INDICES> op;
