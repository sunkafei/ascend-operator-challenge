...
OperatorDesc CreateOpDesc()
{
    ...
    opDesc.AddOutputTensorDesc(dataType, shapeMean.size(), shapeMean.data(), format);
    opDesc.AddOutputTensorDesc(dataType, shapeMean.size(), shapeMean.data(), format);
    return opDesc;
}
...
bool ProcessOutputData(OpRunner &runner)
{
    ...
    WriteFile("../output/output_mean.bin", runner.GetOutputBuffer<void>(1), runner.GetOutputSize(1));
    WriteFile("../output/output_variance.bin", runner.GetOutputBuffer<void>(2), runner.GetOutputSize(2));
